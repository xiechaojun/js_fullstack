...
export const SET_CURRENT_INDEX = 'SET_CURRENT_INDEX'   //设置播放音的乐索引
export const SET_PLAYING = 'SET_PLAYING' // 歌曲播放状态
export const SAVE_PLAY_HISTORY = 'SAVE_PLAY_HISTORY'  //保存播放过的歌曲
export const SAVE_FAVORITE_LIST = 'SAVE_FAVORITE_LIST'  //保存最喜欢的歌曲列表